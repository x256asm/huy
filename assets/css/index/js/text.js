...
window.setInterval(doInverseSpinZeroPitch,150);});$(function(){$(".typed").typed({strings:['SVPRA',"kto eto","машина","beginner nedoпрограммист"],typeSpeed:100,loop:true,cursorChar:"|",});});